...
const validationSchema = Yup.object().shape ({
  oldPassword: Yup.string().min(8, 'Password must be at least 8 characters').required('Your current password is needed to change password'),
...
const profileDetails = profileData.dashboardData?.profileInfo.password.toString();
    ...
    <div className="lg:mx-8 ml-5 mt-[26px]">
      ...
      >
        <Form>
          ...
          <button type="submit" className='py-2.5 px-4 bg-yellow border border-yellow rounded-[8px] font-formular-medium text-[14px] leading-[20px] mt-[66px] mb-[26px]'>Update Password</button>
        </Form>
      </Formik>
    </div>
  );
