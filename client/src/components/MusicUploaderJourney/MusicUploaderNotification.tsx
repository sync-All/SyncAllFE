  ...
  return (
    ...
    >
      <div className=" h-[594px] py-[12px]  bg-white z-10">
        <div className='flex items-center justify-between'><h2 className="font-formular-bold text-[24px] leading-8 tracking-[-0.5px] text-[#202020]">
          Notifications
        </h2>
        <span onClick={onRequestClose} className='text-xl font-formular-bold cursor-pointer '>X</span></div>
