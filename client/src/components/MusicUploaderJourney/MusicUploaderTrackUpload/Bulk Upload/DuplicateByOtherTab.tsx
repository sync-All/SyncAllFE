      ...
      {paginatedItems.length > 0 ? (
            ...
            <tbody>
              {paginatedItems.map((track, index) => (
                <tr key={index} className="border-b border-[#EAECF0]">
                  <td className="text-[#101828] font-formular-medium text-[14px] leading-5 py-3 px-6">
                    {track.trackTitle}
                  </td>
        ...
        <div className="text-center mt-[109px] text-[16px] leading-[20px] py-6">
          ...
          <p className="font-Utile-medium mt-6 text-[16px] text-[#98A2B3]">
            No duplicate uploads by other user found
          </p>
        </div>
      )}
    </>
...
export default DuplicateByOtherTab;
