...
const Sampling = () => {
  ...
  //     console.log('Setting file names:', newFileNames);
  //     setFileName(newFileNames);
  //   } else {
  //     console.log('No new files selected, keeping current file name');
  //   }

  //   // Log the current files state after a short delay to ensure state has updated
  //   setTimeout(() => {
              ...
              <Form className="mt-[60px]">
                <div className="flex flex-col">
                  ...
                  <span className={applyFormDiv}>
                    {' '}
                    <span className="w-[367px] flex flex-col gap-2 mb-4">
                      <label htmlFor="attachments" className={applyLabelStyles}>
                        Artist Name:
                      </label>
                      <Field
                        className={applyInputStyles}
